...
{{/*
Signer Selector labels
*/}}
{{- define "template.signSelectorLabels" -}}
app.kubernetes.io/name: {{ include "template.name" . }}-sign
app.kubernetes.io/instance: {{ .Release.Name }}-sign
{{- end }}


{{- define "template.apiPorts" -}}
